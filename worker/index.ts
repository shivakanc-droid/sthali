...
const taskUseCases: TaskUseCase[] = [
  ...
  { agent_address: "text-diff-checker-agent@sthali.com", keywords: ["text diff", "compare text", "line changes", "changed lines"], intent: "compare_text", payload: { before: "Original text", after: "Updated text" }, reason: "Best fit for bounded, deterministic line-by-line text comparison.", score: 12 },
  { agent_address: "lorem-ipsum-generator-agent@sthali.com", keywords: ["lorem ipsum", "placeholder text", "dummy text"], intent: "generate_lorem_ipsum", payload: { unit: "paragraphs", count: 2 }, reason: "Best fit for deterministic placeholder text generation.", score: 12 },
  { agent_address: "remove-duplicate-lines-agent@sthali.com", keywords: ["remove duplicate lines", "deduplicate lines", "unique lines"], intent: "remove_duplicate_lines", payload: { text: "alpha\nbeta\nalpha" }, reason: "Best fit for removing repeated lines while preserving first-seen order.", score: 12 },
  { agent_address: "slug-generator-agent@sthali.com", keywords: ["slug generator", "url slug", "generate slug", "seo slug"], intent: "generate_slugs", payload: { items: ["Hello Sthali", "Agent Exchange"] }, reason: "Best fit for deterministic URL-safe Latin slugs.", score: 12 },
  { agent_address: "markdown-table-generator-agent@sthali.com", keywords: ["markdown table", "csv to markdown", "table generator", "tsv to markdown"], intent: "generate_markdown_table", payload: { rows: [["Name", "Value"], ["Sthali", "Agent Exchange"]] }, reason: "Best fit for converting structured rows, CSV, or TSV into Markdown tables.", score: 12 },
  { agent_address: "json-formatter-agent@sthali.com", keywords: ["json formatter", "format json", "validate json", "pretty print json"], intent: "format_json", payload: { text: "{\"agent\":\"Sthali\"}", indent: 2 }, reason: "Best fit for bounded JSON validation and formatting.", score: 12 },
  { agent_address: "base64-encoder-decoder-agent@sthali.com", keywords: ["base64", "encode base64", "decode base64"], intent: "transform_base64", payload: { action: "encode", text: "Hello Sthali" }, reason: "Best fit for UTF-8 Base64 encoding and decoding.", score: 12 },
  { agent_address: "url-encoder-decoder-agent@sthali.com", keywords: ["url encode", "url decode", "percent encode", "uri component"], intent: "transform_url_encoding", payload: { action: "encode", mode: "component", text: "Sthali agents & tools" }, reason: "Best fit for URL and component percent encoding or decoding.", score: 12 },
  { agent_address: "uuid-generator-agent@sthali.com", keywords: ["uuid generator", "generate uuid", "uuid v4", "unique identifier"], intent: "generate_uuids", payload: { count: 3, format: "standard" }, reason: "Best fit for cryptographically secure UUID v4 generation.", score: 12 },
  { agent_address: "timestamp-converter-agent@sthali.com", keywords: ["timestamp converter", "unix timestamp", "epoch time", "iso 8601"], intent: "convert_timestamp", payload: { value: 0, unit: "seconds" }, reason: "Best fit for Unix timestamp and ISO 8601 conversion to UTC.", score: 12 }
];
